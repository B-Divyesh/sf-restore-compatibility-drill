...
| Claims | Expanded the manifest from 11 to 13 entries and strengthened the privacy scope. | All 13 exact manifest commands passed independently under `/tmp/restore-drill-final-clean-polish-1.vvR5OL/repo` at `205453d`. |
